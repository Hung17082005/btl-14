        ...
        for lead, expected_suggested in zip(
            ...
            [
                [
                    (
                        False,
                        '"New Customer" <new.customer.format@test.example.com>',
                        "Customer Email",
                    )
                ],
                [
                    (
                        False,
                        '"Multi Name" <new.customer.multi.1@test.example.com,new.customer.2@test.example.com>',
                        "Customer Email",
                    )
                ],
                [
                    (
                        False,
                        '"Std Name" <new.customer.simple@test.example.com>',
                        "Customer Email",
                    )
                ],
                [
