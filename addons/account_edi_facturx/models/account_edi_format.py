...
class AccountEdiFormat(models.Model):
    ...
    def _export_facturx(self, invoice):
        ...
        template_values = {
            **invoice._prepare_edi_vals_to_export(),
            ...
            # Chorus PRO fields
            "buyer_reference": "buyer_reference" in invoice._fields
            and invoice.buyer_reference
            or "",
            "contract_reference": "contract_reference" in invoice._fields
            and invoice.contract_reference
            or "",
            "purchase_order_reference": "purchase_order_reference" in invoice._fields
    ...
    def _create_invoice_from_xml_tree(self, filename, tree, journal=None):
        self.ensure_one()
        if (
            self._is_facturx(filename, tree)
