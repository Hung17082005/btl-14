...
class TestTimesheet(TestCommonTimesheet):
    ...
    def test_remaining_hours_on_project(self):
        ...
        self.assertEqual(
            self.project_customer.remaining_hours,
            4.0,
            "Remaining hours should be 4.0 before adding timesheet",
        )
        ...
        self.assertEqual(
            self.project_customer.remaining_hours,
            2.0,
            "Remaining hours should be 2.0 after adding timesheet",
        )
        ...
        self.assertEqual(
            self.project_customer.remaining_hours,
            2.0,
            "Remaining hours should be 2.0 after adding a child task with no timesheets",
        )
        ...
        self.assertEqual(
            self.project_customer.remaining_hours,
            0.0,
            "Remaining hours should be 0.0 after adding timesheet to child task",
        )
    ...
    def test_check_timesheet_user(self):
        ...
        without_user_timesheet = Timesheet.with_context(
            default_employee_id=emp_without_user.id
        ).create(
            {
                "project_id": self.project_customer.id,
                "unit_amount": 8.0,
        ...
        self.assertFalse(
            without_user_timesheet.user_id, "User is not set in timesheet."
        )

        with_user_timesheet = Timesheet.with_context(
        ...
        self.assertEqual(
            with_user_timesheet.user_id,
            self.user_employee,
            "User Employee is set in timesheet.",
        )
