    ...
    def _compute_from_product_id_company_id(self):
        for expense in self.filtered("product_id"):
            ...
            if (
                ...
                or (expense.attachment_number and not expense.unit_amount)
                or (
                    expense.attachment_number
                    and expense.unit_amount
                    and not expense.product_id.standard_price
                )
            ):
            ...
            expense.tax_ids = expense.product_id.supplier_taxes_id.filtered(
                lambda tax: tax.price_include and tax.company_id == expense.company_id
        ...
        return {
            ...
            "context": {
                ...
                "default_partner_bank_id": (
                    self.employee_id.sudo().bank_account_id.id
