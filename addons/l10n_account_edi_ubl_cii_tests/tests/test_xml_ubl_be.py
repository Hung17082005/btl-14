...
class TestUBLBE(TestUBLCommon):
    ...
    def test_rounding_price_unit(self):
        ...
        * Invoice line net amount shall be rounded to two decimals
        ...
        self._assert_invoice_attachment(
            invoice, None, "from_odoo/bis3_out_invoice_rounding.xml"
        )
    ...
    def test_export_with_fixed_taxes_case1(self):
        ...
        self._assert_invoice_attachment(
            invoice, None, "from_odoo/bis3_ecotaxes_case1.xml"
        )
    ...
    def test_export_with_fixed_taxes_case2(self):
        ...
        self.assertEqual(invoice.amount_total, 121)
        self._assert_invoice_attachment(
            invoice, None, "from_odoo/bis3_ecotaxes_case2.xml"
        )
    ...
    def test_export_with_fixed_taxes_case3(self):
        ...
        self.assertEqual(invoice.amount_total, 121)
        self._assert_invoice_attachment(
            invoice, None, "from_odoo/bis3_ecotaxes_case3.xml"
        )
    ...
    def test_export_with_fixed_taxes_case4(self):
        ...
        self._assert_invoice_attachment(
            invoice, None, "from_odoo/bis3_ecotaxes_case4.xml"
        )
    ...
    def test_export_rounding_price_amount(self):
        ...
        price_amounts = etree.fromstring(attachment.raw).findall(
    ...
    def test_export_tax_exempt(self):
        ...
        self._assert_invoice_attachment(
            invoice, None, "from_odoo/bis3_out_invoice_tax_exempt.xml"
        )
    ...
    def test_import_fixed_taxes(self):
        ...
        self._assert_imported_invoice_from_file(
            ...
            amount_total=121,
            amount_tax=22,
            list_line_subtotals=[99],
            currency_id=self.currency_data["currency"].id,
            list_line_price_unit=[99],
            list_line_discount=[0],
            list_line_taxes=[tax_21 + self.recupel],
            move_type="out_invoice",
        )
        self._assert_imported_invoice_from_file(
            subfolder=subfolder,
            ...
            amount_total=121,
            amount_tax=23,
            list_line_subtotals=[98],
            currency_id=self.currency_data["currency"].id,
            list_line_price_unit=[98],
            list_line_discount=[0],
            list_line_taxes=[tax_21 + self.recupel + self.auvibel],
            move_type="out_invoice",
        )
        self._assert_imported_invoice_from_file(
            subfolder=subfolder,
        ...
        self._assert_imported_invoice_from_file(
            ...
            amount_tax=39.842,
            list_line_subtotals=[178.2],
            currency_id=self.currency_data["currency"].id,
            list_line_price_unit=[99],
            list_line_discount=[10],
            list_line_taxes=[tax_21 + self.recupel],
            move_type="out_invoice",
        )
    ...
    def test_inverting_negative_price_unit(self):
        ...
        self._assert_invoice_attachment(
            invoice, None, "from_odoo/bis3_out_invoice_negative_unit_price.xml"
        )
