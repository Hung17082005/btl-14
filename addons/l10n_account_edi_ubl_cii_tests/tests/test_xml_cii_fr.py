...
class TestCIIFR(TestUBLCommon):
    ...
    def test_export_with_fixed_taxes_case1(self):
        ...
        self._assert_invoice_attachment(
            invoice, None, "from_odoo/facturx_ecotaxes_case1.xml"
        )
    ...
    def test_export_with_fixed_taxes_case2(self):
        ...
        self.assertEqual(invoice.amount_total, 121)
        self._assert_invoice_attachment(
            invoice, None, "from_odoo/facturx_ecotaxes_case2.xml"
        )
    ...
    def test_export_with_fixed_taxes_case3(self):
        ...
        self.assertEqual(invoice.amount_total, 121)
        self._assert_invoice_attachment(
            invoice, None, "from_odoo/facturx_ecotaxes_case3.xml"
        )
    ...
    def test_import_fixed_taxes(self):
        ...
        self._assert_imported_invoice_from_file(
            subfolder=subfolder,
            filename="facturx_ecotaxes_case1.xml",
            amount_total=121,
            amount_tax=22,
            ...
            list_line_taxes=[self.tax_21 + self.recupel],
            move_type="out_invoice",
        )
        self._assert_imported_invoice_from_file(
            subfolder=subfolder,
            filename="facturx_ecotaxes_case2.xml",
            amount_total=121,
            amount_tax=23,
            ...
            list_line_discount=[0],
            list_line_taxes=[self.tax_21 + self.recupel + self.auvibel],
            move_type="out_invoice",
        )
        self._assert_imported_invoice_from_file(
            subfolder=subfolder,
            filename="facturx_ecotaxes_case3.xml",
            amount_total=121,
            amount_tax=22,
            list_line_subtotals=[99],
            currency_id=self.currency_data["currency"].id,
