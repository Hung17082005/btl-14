...
class TestReconciliationExec(TestAccountReconciliationCommon):
        ...
        payment_a = self.env["account.payment"].create(
            {
                ...
                "partner_id": self.partner_agrolait_id,
                "payment_method_line_id": self.bank_journal_euro.inbound_payment_method_line_ids[
                    0
                ].id,
        ...
        payment_b = self.env["account.payment"].create(
            {
                ...
                "partner_id": self.partner_agrolait_id,
                "payment_method_line_id": self.bank_journal_euro.outbound_payment_method_line_ids[
                    0
                ].id,
                "partner_type": "supplier",
            }
        ...
        payment = self.env["account.payment"].create(
            {
                ...
                "payment_method_line_id": self.bank_journal_usd.inbound_payment_method_line_ids[
                    0
                ].id,
    ...
    def test_reconciliation_with_old_oustanding_account(self):
        ...
        """
        outstanding_account_1 = self.company_data[
            "company"
        ].account_journal_payment_debit_account_id.copy()
        outstanding_account_2 = outstanding_account_1.copy()

        self.company_data[
            "default_journal_bank"
        ].inbound_payment_method_line_ids.payment_account_id = outstanding_account_1
        ...
        credit_line = payment.line_ids.filtered(
            lambda l: l.credit and l.account_id == self.account_rcv
        )
