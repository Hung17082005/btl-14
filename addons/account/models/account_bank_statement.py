...
from odoo.tools.misc import format_date, formatLang, str2bool
...
class AccountBankStatement(models.Model):
    ...
    def _check_balance_end_real_same_as_computed(self):
        ...
        return (
            ...
            and self._check_bank_balance_end_real_same_as_computed()
        )
        ...
        for statement in self.filtered(lambda stmt: stmt.journal_type == "bank"):
            if not statement.currency_id.is_zero(statement.difference):
                ...
                balance_end = formatLang(
                    self.env, statement.balance_end, currency_obj=statement.currency_id
                )
                raise UserError(
                    _(
...
class AccountBankStatementLine(models.Model):
    ...
    def _prepare_reconciliation(self, lines_vals_list, allow_partial=False):
        ...
        total_amount_currency = -self._prepare_move_line_default_vals()[1][
            "amount_currency"
        ]
