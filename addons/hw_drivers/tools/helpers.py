...
def compute_iot_handlers_addon_name(handler_kind, handler_file_name):
    ...
    return "odoo.addons.hw_drivers.iot_handlers.{handler_kind}.{handler_name}".format(
        handler_kind=handler_kind, handler_name=handler_file_name.replace(".py", "")
    )
    ...
    for directory in ["interfaces", "drivers"]:
        ...
        for file in filesList:
            ...
            spec = util.spec_from_file_location(
                compute_iot_handlers_addon_name(directory, file), path_file
            )
            if spec:
