...
from cups import IPP_PRINTER_IDLE, IPP_PRINTER_PROCESSING, IPP_PRINTER_STOPPED, IPPError
...
class PrinterDriver(Driver):
    ...
    def print_raw(self, data):
        ...
        if process.returncode != 0:
            ...
            _logger.error(
                'Printing failed: printer with the identifier "%s" could not be found',
    ...
    def format_escpos(self, im):
        ...
        if image_mode == "column":
            ...
            res = self.format_escpos_bit_image_column(
