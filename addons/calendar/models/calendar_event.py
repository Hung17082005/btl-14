...
from odoo.tools import html2plaintext, is_html_empty, pycompat
...
class Meeting(models.Model):
    ...
    def _get_ics_file(self):
        ...
        for meeting in self:
            ...
            if not is_html_empty(meeting.description):
                if (
                    ...
                    event.add("description").value = (
                        self.convert_online_event_desc_to_text(meeting.description)
                    )
                else:
            ...
            event.add("organizer").value = "MAILTO:" + (meeting.user_id.email or "")
